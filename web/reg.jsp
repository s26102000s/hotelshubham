...
<section class="register" style="color: black;">
    ...
    <div class="container-fluid">
        <div id="main">
            <div id="form_layout">
                <form  class="form"  action="afterbooking.jsp" name="bookroom">
                    <p id="head"></p><br>
                    <table border="5px solid yellow" style="padding: 10px;">
                        ...
                        <div class="form-group">
                            <tr>
                            	...
                            	<td><input type="text" class="form-control" placeholder="Enter email" name="email" id="email"><br><p id="a2"></p></td>
                            </tr>
                        </div>
                        <div class="form-group">
                           <tr>
                        ...
                        <div class="form-group">
                            <tr>
                                ...
                                <td><input type="date" id="cin" name="cin" class="form-control" placeholder="dd/mm/yyyy"><br><p id="a7"></p></td>
                            </tr>
                        </div>
                        <div class="form-group">
                            <tr>
                            	<td><label class="control-label" for="date">&nbsp;date of check-out</label></td>
                                <td><input type="date" id="cout" name="cout" class="form-control" placeholder="dd/mm/yyyy"><br><p id="a8"></p></td>
                            </tr>
                        </div>
                        <div class="form-group">
                            <tr>
