...
<div class="header_search">
   ...
   <h1 style="color:#000;margin-top:20px">Admin Profile <span style="color:rgb(233, 79, 49);"></span></h1>
    </div>
...
while(rs.next())
    ...
    String sr = rs.getString("username");
    int id = rs.getInt("id");
...
<td><% out.print(mob); %></td>
    <td><% out.print(sr); %></td>
<td><a href="change.jsp?var=<%=id%>"><input type="submit"  value="Edit" class="frmm" /></a></td>
