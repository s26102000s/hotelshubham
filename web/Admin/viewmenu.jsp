...
<div class="header_search">
   ...
   <h1 style="color:#000;margin-top:20px">Menu Items <span style="color:rgb(233, 79, 49);"></span></h1>
    </div>
...
<td><% out.print(em); %></td>
<td><% out.print(cot); %></td>
<td><a href="menuedit.jsp?var=<%=id%>"><input type="submit"  value="Edit" class="frmm" /></a></td>
<td><a href="menudelete.jsp?var=<%=id%>"><input type="submit"  value="Delete" class="frmm" /></a></td>
</tr>
<%
