...
<?php
  ...
  if(isset($_POST['register'])){
    ...
    $sql="insert into vendorregister(name,email,contact,password) values('$name','$email','$contact','$password')";
    ...
    {
      echo "<script>alert('Oops!! Sorry Please try again');</script>";
    }
  }
?>
<head>
    ...
    <div class="row clearfix">
      <div class="">
        <form method="post">
          ...
          <a href="index.php" style="margin-left: 80%;">Sign In</a>
        </form>
      </div>
    </div>
  </div>
