...
<div class="wrapper">
  ...
  <div class="wrapperr">
    <div class="from_container">
      <form action="after_addmenu.jsp" name="myForm" method="post"   >
        <table>
          <tr>
            <td style="color:#666;">Item Name:</td>
            <td><input type="text" name="name" placeholder="Please Enter  Here" class="frm"/></td>
          </tr>
          <tr>
            <td style="color:#666;">Item Price</td>
            <td><input type="text" name="price" placeholder="Please Enter  Here" class="frm"/></td>
          </tr>
          <tr>
            <td style="color:#666;">Item Description</td>
            <td><textarea type="text" name="des" placeholder="Please Enter  Here" class="frm"></textarea></td>
          </tr>
