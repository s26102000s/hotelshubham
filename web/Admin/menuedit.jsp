...
String Query= "select * from menu where id='"+param+"'";

   Statement stmt=con.createStatement();
  ResultSet rs=stmt.executeQuery(Query);
  if(rs.next())
      {
   String sr = rs.getString("i_name");
    String em = rs.getString("i_price");
    String cot = rs.getString("i_des");
int id = rs.getInt("id");
...
<div class="wrapper">
  ...
  <div class="wrapperr">
    <div class="from_container">
      <form action="editaction.jsp?var=<%= param %>" name="myForm" method="post"   >
        <table>
          <tr>
            <td style="color:#666;">Item Name:</td>
            <td><input type="text" name="name" value="<% out.print(sr); %>" class="frm"/></td>
          </tr>
          <tr>
            <td style="color:#666;">Item Price</td>
            <td><input type="text" name="price" value="<% out.print(em); %>" class="frm"/></td>
          </tr>
          <tr>
            <td style="color:#666;">Item Description</td>
            <td><textarea type="text" name="des"  class="frm"><% out.print(cot); %></textarea></td>
          </tr>
